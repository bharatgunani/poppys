    ...
    $.widget('mage.SwatchRenderer', {
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            var justAnImage = images[0],
                    ...
                    isInitial;
            /*Custom Code*/
            var res = images[0]['back_image'];
            var strres = res.lastIndexOf("/") + 1;
            var filenameWithExtension = res.substr(strres);
            var update_filename = filenameWithExtension.split(".")[0];
            if (update_filename != '') {
                update_filename = images[0]['back_image'];
            } else {
                update_filename = justAnImage.img;
            }
            /*Custom Code*/
            ...
            if (isProductViewExist) {
                ...
                /*custom code*/
                context.find('.product-image-photo.custom-hover').attr('src', update_filename);
                /*custom code*/
