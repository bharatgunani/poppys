define([
...
], function($, Component, ko, confirm, modal) {
    'use strict';
    ...
    var CO_REGISTRANT_BTN_TEXT_ADD    = 'Add Co-Registrant';
    var CO_REGISTRANT_BTN_TEXT_REMOVE = 'Remove Co-Registrant';
    ...
    return Component.extend({
        ...
        removeItem: function(itemId) {
            var self = this;
            confirm({
                content: 'Are you sure you want to remove this product from your Gift Registry?',
                actions: {
                    confirm: function () {
